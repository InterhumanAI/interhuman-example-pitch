...
export const metadata = {
  title: "Terms of Service - PitchPerfect",
  description: "Terms and conditions for using PitchPerfect.",
};
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using PitchPerfect, you agree to be bound by these Terms of Service. 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              PitchPerfect is a pitch practice tool that uses AI-powered video analysis to provide 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The behavioral analysis and scores provided by PitchPerfect are generated by AI 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              To the maximum extent permitted by law, PitchPerfect and its operators shall not 
